...
import { Plus, Edit, Trash2, Power, Search, X, TrendingUp, Package, DollarSign, AlertTriangle, History, Download, Star, ZoomIn, Upload, Image as ImageIcon, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="mt-4 p-4 border rounded-lg bg-white">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-600">
              Página {paginaAtual} de {totalPaginas} | Mostrando {indiceInicial + 1} a {Math.min(indiceFinal, produtosFiltrados.length)} de {produtosFiltrados.length} produtos
            </div>
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
