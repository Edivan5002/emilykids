...
import { Plus, Edit, Trash2, Power, Search, DollarSign, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Fornecedores = () => {
  ...
  return (
    <div className="page-container" data-testid="fornecedores-page">
      ...
      {filteredFornecedores.length > ITENS_POR_PAGINA && (
        <div className="mt-4 p-4 border rounded-lg bg-white">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-600">
              Página {paginaAtual} de {totalPaginas} | Mostrando {indiceInicial + 1} a {Math.min(indiceFinal, filteredFornecedores.length)} de {filteredFornecedores.length} fornecedores
            </div>
