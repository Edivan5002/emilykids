...
import { Plus, Edit, Trash2, Power, Search, DollarSign, ChevronLeft, ChevronRight, CreditCard, Gift, Wallet } from 'lucide-react';
...
const Clientes = () => {
  ...
  return (
    <div className="page-container" data-testid="clientes-page">
      ...
      {filteredClientes.length > ITENS_POR_PAGINA && (
        <div className="mt-4 p-4 border rounded-lg bg-white">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-600">
              Página {paginaAtual} de {totalPaginas} | Mostrando {indiceInicial + 1} a {Math.min(indiceFinal, filteredClientes.length)} de {filteredClientes.length} clientes
            </div>
